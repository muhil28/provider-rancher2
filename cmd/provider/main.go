...
import (
	...
	"github.com/muhil28/provider-rancher2/apis"
	"github.com/muhil28/provider-rancher2/apis/v1alpha1"
	"github.com/muhil28/provider-rancher2/config"
	"github.com/muhil28/provider-rancher2/internal/clients"
	"github.com/muhil28/provider-rancher2/internal/controller"
	"github.com/muhil28/provider-rancher2/internal/features"
)
...
func main() {
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add Rancher2 APIs to scheme")
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Rancher2 controllers")
